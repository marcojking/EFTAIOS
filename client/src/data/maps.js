...
// Based on verified transcription
const leviMontalciniLayout = [
  // --- Col B (1) ---
  ...
  { col: 3, row: 6, state: 'dangerous' },  // D06 (Corrected)
  { col: 3, row: 7, state: 'dangerous' },  // D07
  { col: 3, row: 8, state: 'secure' },     // D08 (Corrected)
  { col: 3, row: 9, state: 'dangerous' },  // D09
  { col: 3, row: 10, state: 'dangerous' }, // D10
  { col: 3, row: 11, state: 'dangerous' }, // D11 (Corrected)
  { col: 3, row: 12, state: 'secure' },    // D12 (Corrected)
  ...
  // --- Col G (6) ---
  // G01, G02 X
  { col: 6, row: 3, state: 'secure' },     // G03 (Corrected)
  { col: 6, row: 4, state: 'dangerous' },  // G04
  { col: 6, row: 6, state: 'dangerous' },  // G06
  { col: 6, row: 8, state: 'dangerous' },  // G08
  { col: 6, row: 10, state: 'dangerous' }, // G10
  ...
  { col: 7, row: 4, state: 'dangerous' },  // H04 (Corrected)
  // H05 X
  { col: 7, row: 6, state: 'secure' },     // H06
  { col: 7, row: 7, state: 'secure' },     // H07
  { col: 7, row: 9, state: 'dangerous' },  // H09 (Corrected)
  { col: 7, row: 10, state: 'dangerous' }, // H10
  { col: 7, row: 11, state: 'dangerous' }, // H11
  ...
  // --- Col J (9) ---
  { col: 9, row: 2, state: 'dangerous' },  // J02 (Corrected)
  { col: 9, row: 3, state: 'dangerous' },  // J03 (Corrected)
  { col: 9, row: 5, state: 'dangerous' },  // J05
  { col: 9, row: 6, state: 'dangerous' },  // J06
  { col: 9, row: 8, state: 'dangerous' },  // J08
  { col: 9, row: 9, state: 'dangerous' },  // J09
  ...
  // --- Col K (10) ---
  { col: 10, row: 2, state: 'dangerous' }, // K02 (Corrected)
  { col: 10, row: 3, state: 'secure' },    // K03
  { col: 10, row: 4, state: 'dangerous' }, // K04
  { col: 10, row: 5, state: 'dangerous' }, // K05
  { col: 10, row: 6, state: 'secure' },    // K06
  { col: 10, row: 7, state: 'human-start' }, // K07 (Corrected - Human Start)
  { col: 10, row: 8, state: 'secure' },    // K08
  ...
  { col: 11, row: 3, state: 'dangerous' }, // L03
  { col: 11, row: 4, state: 'secure' },    // L04 (Corrected)
  // L05, L06, L07, L08 X (Gaps)
  { col: 11, row: 9, state: 'dangerous' }, // L09 (Corrected)
  { col: 11, row: 10, state: 'dangerous' }, // L10 (Corrected)
  { col: 11, row: 11, state: 'dangerous' }, // L11 (Corrected)
  { col: 11, row: 12, state: 'dangerous' }, // L12 (Corrected)
  { col: 11, row: 13, state: 'dangerous' }, // L13
  ...
  { col: 12, row: 4, state: 'dangerous' }, // M04
  { col: 12, row: 5, state: 'dangerous' }, // M05
  { col: 12, row: 6, state: 'secure' },    // M06 (Corrected)
  { col: 12, row: 7, state: 'alien-start' }, // M07 (Corrected - Alien Start)
  { col: 12, row: 8, state: 'secure' },    // M08
  { col: 12, row: 9, state: 'dangerous' }, // M09
  { col: 12, row: 10, state: 'dangerous' }, // M10
  { col: 12, row: 11, state: 'dangerous' }, // M11
  ...
  { col: 14, row: 4, state: 'dangerous' }, // O04
  { col: 14, row: 5, state: 'secure' },    // O05 (Corrected)
  { col: 14, row: 6, state: 'dangerous' }, // O06
  { col: 14, row: 7, state: 'dangerous' }, // O07
  { col: 14, row: 8, state: 'dangerous' }, // O08
  { col: 14, row: 9, state: 'dangerous' }, // O09
  ...
  // P10, P11 X (Corrected)
  { col: 15, row: 12, state: 'dangerous' }, // P12 (Corrected)
  // P13 X (Corrected)
  ...
  // --- Col S (18) ---
  { col: 18, row: 3, state: 'dangerous' }, // S03
  { col: 18, row: 4, state: 'dangerous' }, // S04 (Corrected)
  { col: 18, row: 5, state: 'dangerous' }, // S05 (Corrected)
  { col: 18, row: 7, state: 'dangerous' }, // S07
  { col: 18, row: 8, state: 'dangerous' }, // S08
  { col: 18, row: 10, state: 'dangerous' }, // S10
  ...
  // --- Col T (19) ---
  { col: 19, row: 2, state: 'dangerous' }, // T02 (Corrected)
  ...
  { col: 19, row: 11, state: 'dangerous' }, // T11 (Corrected)
  ...
  { col: 20, row: 6, state: 'dangerous' }, // U06
  { col: 20, row: 7, state: 'secure' },    // U07 (Corrected)
  { col: 20, row: 8, state: 'dangerous' }, // U08
...
export const LEVI_MONTALCINI_MAP = {
  type: 'map',
